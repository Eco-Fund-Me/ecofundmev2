        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="pl-10 w-full rounded-md border border-gray-300 py-2 px-3 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#00EE7D] focus:border-[#00EE7D]"
              value={searchQuery}
                  ...
                  {[
                    ...
                    <div
                      ...
                      className={`px-4 py-2 text-sm cursor-pointer hover:bg-gray-100 ${
                        statusFilter === option.value ? "bg-[#00EE7D]/10 text-[#00EE7D]" : "text-gray-700"
                      }`}
                      onClick={() => {
        ...
        {isLoading ? (
          ...
          <div className="text-center py-8">
            ...
            <button
              ...
              className="mt-4 px-4 py-2 bg-[#00EE7D] text-black rounded-md hover:bg-[#00EE7D]/90"
            >
              Try Again
            </button>
          </div>
                    ...
                    <tr key={app.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <Link
                          ...
                          className="inline-flex items-center px-3 py-1.5 border border-gray-300 text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00EE7D]"
                        >
                          View
                        </Link>
                      </td>
