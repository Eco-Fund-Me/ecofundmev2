    ...
    return (
      <div className="text-center py-12">
        ...
        <button
          ...
          className="px-4 py-2 bg-[#00EE7D] text-black rounded-md hover:bg-[#00EE7D]/90"
        >
          Try Again
        </button>
      </div>
        ...
        <div className="flex space-x-2">
          {application.status === "pending" && (
            <>
              ...
              <button
                className="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-black bg-[#00EE7D] hover:bg-[#00EE7D]/90"
          ...
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-4">
                      ...
                      <textarea
                        id="approve-note"
                        rows={4}
                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-[#00EE7D] focus:border-[#00EE7D] sm:text-sm"
              ...
              <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button
                  type="button"
                  className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-[#00EE7D] text-base font-medium text-black hover:bg-[#00EE7D]/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00EE7D] sm:ml-3 sm:w-auto sm:text-sm"
                ...
                <button
                  type="button"
                  className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00EE7D] sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
