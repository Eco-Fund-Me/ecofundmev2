  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="lg:hidden">
        <div
          className="fixed inset-0 bg-[#040B08]/80 z-40"
            ...
            {navigation.map((item) => (
              <Link
                ...
                className={`flex items-center px-2 py-2 text-sm font-medium rounded-md ${
                  pathname === item.href ? "bg-[#00EE7D]/10 text-[#00EE7D]" : "text-gray-600 hover:bg-gray-100"
                }`}
              >
      ...
      <div className="lg:pl-64 flex flex-col flex-1">
        <div className="sticky top-0 z-10 flex items-center h-16 bg-white border-b border-gray-200 lg:hidden">
          <button
            type="button"
            className="px-4 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#00EE7D]"
